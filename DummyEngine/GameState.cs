    ...
    public void Draw(SpriteBatch spriteBatch, GameTime gameTime)
    {
        ...
        if (speakerImage != null)
        {
            ...
            var destinationRectangle =
                new Rectangle(0, 0, newWidth, newHeight); // Position und Größe für das Zeichnen
            var sourceRectangle =
                new Rectangle(0, 0, speakerImage.Width,
                    speakerImage.Height); // Der Bereich des Bildes, der gezeichnet werden soll

            spriteBatch.Draw(speakerImage, destinationRectangle, sourceRectangle,
                Color.White * currentContentAlpha);
        }
